...
void scan(int requests[], int total_requests, int current_head_position, int direction) {
...
int main() {
    ...
    scan(requests, 200, current_head_position, direction);
    return 0;
}
